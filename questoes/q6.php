...
<head>
  ...
  <title>Handport - Questão 6</title>
...
<body>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
          <h1 class="masthead-heading mt-3 mb-0">Questão 5</h1>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="p-3">
              ...
              <p class="lead">Posicione as palavras de modo que formem frases:</p>
                ...
                <div class="col-lg">
                  ...
                  <div class="bg-light rounded border p-4 text-center">
                    <div class="container">
                      ...
                      <select class="btn btn-warning mx-2 font-130" name="">
                        <option value="">Selecione</option>
                        <option value="">Selecione</option>
                        <option value="">Selecione</option>
                        <option value="">Selecione</option>
                      ...
                      <select class="btn btn-danger mx-2 font-130" name="">
                        <option value="">Selecione</option>
                        <option value="">Selecione</option>
                        <option value="">Selecione</option>
                        <option value="">Selecione</option>
